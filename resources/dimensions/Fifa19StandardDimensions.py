class Dimensions:
    def __init__(self):
        ...
        self.top_margin_name = 440

        self.top_margin_player_overall = 80
        ...
        self.left_margin_attr_value_col2 = self.left_margin_attr_value_col1 + 190
        ...
        self.top_margin_label_offset = 5
        ...
        self.left_margin_dynamic_player_image = 45
